...
1. Install the [Aqara OpenAPI Local](https://clawhub.ai/aqara/aqara-open-api-local) Skill for your OpenClaw. For example, you can directly enter `Install Aqara OpenAPI Local Skill` in the input box, and the Assistant will start installing the Skill.
