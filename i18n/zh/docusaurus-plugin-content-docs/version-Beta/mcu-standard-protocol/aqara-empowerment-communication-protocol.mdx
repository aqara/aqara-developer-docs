...
#### Overall Checksum — 整体校验 {#overall-checksum--整体校验}
...
## 第六章 Foundation Profile（Profile ID = 0x0000） {#第六章-foundation-profileprofile-id--0x0000}
...
## 第七章 Thermostat Profile（Profile ID = 0x1000） {#第七章-thermostat-profileprofile-id--0x1000}
